                ...
                <div class="modal-body editModalAnswers">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" class="w-100" id="question" name="question"
...
<div class="modal fade" id="showAnsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Show the Answers</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
$(document).ready(function() {
    ...
    //edit and update questions and answers script
    ...
    //update the Question and Answer form submission
    $("#editQna").submit(function(e) {
        e.preventDefault();

        if ($(".editAnswers").length < 2) {
            $(".editError").text("Please add a minimum of two answers!")
            setTimeout(function() {
                $(".editError").text("");
            }, 2000);
            ...
            if (checkIsCorrect) {
                ...
                $(".editError").text("Please select any one correct answer!")
                setTimeout(function() {
                    $(".editError").text("");
                }, 2000);
            }
